...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lambdafy = function () {
	    function Lambdafy() {
	        _classCallCheck(this, Lambdafy);
	    }

	    _createClass(Lambdafy, null, [{
	        key: 'fromExpress',
	        value: function fromExpress(expressApp) {
	            var _this = this;

	            var app = expressApp;
	            app.response = new _response2.default();
	            app.handleRequest = function (event, context, cb) {
	                return _this.expressRequestHandler(app, event, context, cb);
	            };
	            return app;
	        }
	    }, {
	        key: 'expressRequestHandler',
	        value: function expressRequestHandler(app, event, context, cb) {
	            ...
	            req.body = _qs2.default.parse(event.body);
	            req.headers = {};
	            ...
	            var res = new _http2.default.ServerResponse(req);
...
/***/ function(module, exports) {
	...
	var request = function () {
	    ...
	    _createClass(request, [{
	        ...
	        key: "acceptsCharset",
	        value: function acceptsCharset() {}
	    }, {
	        key: "acceptsLanguages",
	        value: function acceptsLanguages() {}
	    }, {
	        key: "range",
	        value: function range(size, options) {}
	    }, {
	        key: "param",
	        value: function param(name, defaultValue) {}
	    }, {
	        key: "is",
...
/***/ function(module, exports) {
	...
	var response = function () {
	    ...
	    _createClass(response, [{
	        ...
	        key: "jsonp",
	        value: function jsonp(obj) {}
	    }, {
	        key: "sendStatus",
	        value: function sendStatus(statusCode) {}
	    }, {
	        key: "sendFile",
	        value: function sendFile(path, options, callback) {}
	    }, {
	        key: "download",
	        value: function download(path, filename, callback) {}
	    }, {
	        key: "contentType",
	        ...
	        key: "header",
	        value: function header(field, val) {
	        ...
	        key: "clearCookie",
	        value: function clearCookie(name, option) {}
	    }, {
	        key: "cookie",
	        value: function cookie(name, value, options) {}
	    }, {
	        key: "location",
	        value: function location(url) {}
	    }, {
	        key: "redirect",
	        ...
	        key: "vary",
	        value: function vary(field) {}
	    }, {
	        key: "render",
	        value: function render(view, options, callback) {
